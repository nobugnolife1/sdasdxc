(function ($) {
    ...
    /*---slick column4 activation---*/
    $('.slick_column4').slick({
        centerMode: true,
        centerPadding: '0',
        slidesToShow: 4,
        rows: 2,
        prevArrow:'<button class="prev_arrow"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>',
        nextArrow:'<button class="next_arrow"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>', 
        responsive:[
            {
              breakpoint: 576,
              settings: {
